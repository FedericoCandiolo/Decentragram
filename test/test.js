...
contract('Decentragram', ([deployer, author, tipper]) => {
  ...
  describe('images', async () => {
    ...
    before(async () => {
      result = await decentragram.uploadImage(hash, 'Image description', {from: author}); //El from: author (ultimo parametro) es metadata. No es parte de la funcion de js, simula quien llama la funcion. author viene de la declaracion del contrato decentragram
